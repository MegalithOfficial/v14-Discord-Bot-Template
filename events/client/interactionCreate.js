...
module.exports = {
  ...
  execute(interaction) {
    ...
    if (interaction.isChatInputCommand()) {
      ...
      console.log(`${interaction.user.tag} adlı kullanıcı /${interaction.commandName} komutunu kullandı. Kanal: #${interaction.channel.name} Sunucu: ${interaction.guild.name}` );
